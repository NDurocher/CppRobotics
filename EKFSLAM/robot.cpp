...
Eigen::MatrixXd robot::Observation(Eigen::MatrixXd Xtrue, Eigen::MatrixXd LM_pos) {
	double Nh = distribution(generator);
...
Eigen::MatrixXd robot::Predict(Eigen::MatrixXd Xest, Eigen::MatrixXd U, Eigen::MatrixXd z) {
...
Eigen::MatrixXd robot::Update(Eigen::MatrixXd U, Eigen::MatrixXd Xest, Eigen::MatrixXd z_obs){
